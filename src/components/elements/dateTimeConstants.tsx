...
const styles = {
  dark: {
    wrapper:
      'w-full flex justify-center items-center h-28 shadow-lg border border-slate-300 bg-slate-600 shadow-gray-300',
    display:
  ...
  light: {
    ...
    display:
      'flex flex-col border py-1 px-2 w-[260px] rounded bg-slate-300  border-slate-500 shadow-xl shadow-gray-300',
  },
  ...
  date: 'text-[42px] time-display tracking-widest grid grid-cols-3',
};
